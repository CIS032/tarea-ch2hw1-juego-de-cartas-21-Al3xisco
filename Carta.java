...
public class Carta {
     ...
     * @param elValor el valor de la nueva tarjeta. Para una tarjeta regular (no bromista),
     ...
     * @param elTraje el traje de la nueva tarjeta. Este debe ser uno de los valores
